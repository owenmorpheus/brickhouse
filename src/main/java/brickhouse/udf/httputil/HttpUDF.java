 ...
 * @create 2022/02/11
 */
public class HttpUDF extends UDF {
    public static HttpsURLConnection conn = null;
    public String evaluate(String input) throws InterruptedException, NoSuchAlgorithmException, KeyManagementException {
